...
static const char col_gray4[]       = "#eeeeee";	// current tag and window
static const char col_cyan[]        = "#005577";	// active window border and bar second color
